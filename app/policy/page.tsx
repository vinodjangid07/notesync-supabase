  ...
  return (
    ...
    <div className="bg-background min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <motion.div 
        ...
        className="max-w-4xl mx-auto bg-background rounded-2xl overflow-hidden border border-border"
      >
        ...
        <div className="p-8 space-y-8">
          ...
          <section>
            ...
            <div className="mb-6">
              <h3 className="text-xl font-medium text-primary mb-2">Content Information</h3>
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-1">
            ...
            <div>
              <h3 className="text-xl font-medium text-primary mb-2">Technical Information</h3>
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-1">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Data Storage and Security</h2>
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-1">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Data Sharing</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Your Rights</h2>
